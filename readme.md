...
There has been some chatter coming my way about what is "official" with respect to HBlink. I can't stop others from claiming they are the "official" source, or using account names that make them look official. All I can say is that I'm the author, and I'm the copyright holder. What is the status?
 ...
 - **HBlink4 (ACTIVE DEEVLOPMENT):** Ground up re-write for modern times. Repeater, not system-based. Supports full dynamic TGID subscription and TS/TGID translation based on "Options" configuration sent by MMDVMHost or DMRGateway. Includes an integrated dashboard application as part of the package.
...
```bash
git clone https://github.com/Justice57201/OHR-SRV.git
cd /opt/HBlink4
```
